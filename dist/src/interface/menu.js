...
function destacarLinkAtivo() {
    ...
    links.forEach((link) => {
        try {
            ...
            if (corresponde) {
                link.classList.add("text-violet-500", "dark:text-violet-500", "font-semibold", "underline", "underline-offset-8", "decoration-2", "hover:text-violet-600", "dark:hover:text-violet-600", "transition-all", "duration-300");
