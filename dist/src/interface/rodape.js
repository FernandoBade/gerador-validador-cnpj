/* ============================
   Rodapé Fixo (Reutilizável)
   - Links: Github, LinkedIn
   - Fixo na base, cores consistentes em light/dark
============================ */
/**
 * @summary HTML do rodapé simplificado, com links para GitHub e LinkedIn.
 */
export const htmlRodape = `
    <footer class="px-6 py-6 mt-8 bg-slate-900 text-zinc-50 dark:bg-slate-900 transition-colors duration-500">
    <div class="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
        ...
        ${new Date().getFullYear()} • Versão 1.9.0 • Licensa ISC
        ...
        <li>
            ...
            class="flex items-center gap-2 text-slate-200 hover:text-violet-500 dark:hover:text-violet-400 transition-colors"
...
export function inicializarRodape() {
    if (document.getElementById("rodape-simples"))
        return;
